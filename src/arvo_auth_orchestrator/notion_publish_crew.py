...
from arvo_auth_orchestrator.tools.notion_publish_claude_tool import NotionPublishViaClaudeTool
from arvo_auth_orchestrator.tools.notion_publish_verify_claude_tool import (
    NotionPublishVerifyViaClaudeTool,
)
from arvo_auth_orchestrator.tools.srs_publish_read_tool import SrsPublishReadTool
...
class SrsNotionPublishCrew:
    ...
    def analyze_srs_notion_structure_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/notion_export/publish_plan.md",
            markdown=True,
        )
    ...
    def execute_notion_publish_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/notion_export/publish_execution_log.md",
            markdown=True,
        )
    ...
    def verify_notion_publish_completeness_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/notion_export/publish_completeness_review.md",
            markdown=True,
        )
