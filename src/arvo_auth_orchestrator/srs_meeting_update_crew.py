...
from arvo_auth_orchestrator.tools.meeting_transcript_read_tool import (
    MeetingTranscriptReadTool,
)
from arvo_auth_orchestrator.tools.meeting_update_artifact_read_tool import (
...
from arvo_auth_orchestrator.tools.notion_collect_page_comments_claude_tool import (
    NotionCollectSrsPageCommentsViaClaudeTool,
)
from arvo_auth_orchestrator.tools.notion_update_versions_claude_tool import (
    NotionUpdateVersionsViaClaudeTool,
)
from arvo_auth_orchestrator.tools.srs_versions_local_update_tool import (
...
class SrsMeetingChangesPlanCrew:
    ...
    def extract_meeting_decisions_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/srs_meeting_update/srs_changes_manifest.md",
            markdown=True,
        )
    ...
    def collect_notion_comment_suggestions_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/srs_meeting_update/notion_comment_suggestions.md",
            markdown=True,
        )
    ...
    def plan_notion_diff_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/srs_meeting_update/notion_changes_diff.md",
            markdown=True,
        )
...
class SrsMeetingChangesApplyCrew:
    ...
    def apply_notion_changes_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/srs_meeting_update/apply_execution_log.md",
            markdown=True,
        )
    ...
    def update_srs_versions_section_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/srs_meeting_update/versions_update_log.md",
            markdown=True,
        )
