...
from arvo_auth_orchestrator.tools.briefing_file_tool import BriefingFileReadTool
from arvo_auth_orchestrator.tools.notion_page_tool import NotionPageReadTool
from arvo_auth_orchestrator.tools.repo_read_tool import RepoReadTool
...
class SrsAuthorCrew:
    ...
    def ingest_product_overview_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/srs_workflow/step_01_ingest_memory.md",
            markdown=True,
        )
    ...
    def materialize_overview_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/srs_workflow/overview.md",
            markdown=True,
        )
    ...
    def research_product_details_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/srs_workflow/product_research_notes.md",
            markdown=True,
        )
    ...
    def materialize_product_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/srs_workflow/product.md",
            markdown=True,
        )
    ...
    def analyze_codebases_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/srs_workflow/repo_analysis.md",
            markdown=True,
        )
    ...
    def snapshot_backend_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/srs_workflow/backend.md",
            markdown=True,
        )
    ...
    def snapshot_frontend_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/srs_workflow/frontend.md",
            markdown=True,
        )
    ...
    def snapshot_infra_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/srs_workflow/infra.md",
            markdown=True,
        )
    ...
    def author_srs_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/srs_workflow/SRS.md",
            markdown=True,
        )
