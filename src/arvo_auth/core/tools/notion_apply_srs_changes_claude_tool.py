...
def _diff_path() -> Path:
    return _project_root() / "outputs" / "engineering" / "srs_meeting_update" / "notion_changes_diff.md"


def _manifest_path() -> Path:
    return _project_root() / "outputs" / "engineering" / "srs_meeting_update" / "srs_changes_manifest.md"
