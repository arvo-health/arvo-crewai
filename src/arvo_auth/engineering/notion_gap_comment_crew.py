...
from arvo_auth.core.tools.notion_page_comment_tool import NotionPostPageCommentTool
from arvo_auth.core.tools.notion_search_tool import NotionSearchPagesTool
...
class NotionGapCommentCrew:
    ...
    def collect_gap_conflict_manifest_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/engineering/notion_gap_comments/gap_comment_manifest.md",
            markdown=True,
        )
    ...
    def post_notion_clarification_comments_task(self) -> Task:
        return Task(
            ...
            output_file="outputs/engineering/notion_gap_comments/gap_comment_execution_log.md",
            markdown=True,
        )
